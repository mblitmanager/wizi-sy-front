          ...
          <div className="mt-6 text-right">
            <Button
              ...
              <span className="flex items-center gap-2">
                Lancer le quiz <ArrowRight className="w-4 h-4" />
              </span>
            </Button>
          </div>
        </div>
              ...
              <button
                ...
                {types.length > 1 && (
                  <span className="mt-2 text-xs text-gray-400">
                    {currentTypeIdx + 1} / {types.length} • Tapotez pour voir le
                    suivant
                  </span>
                )}
              </button>
            ...
            <Swiper
              ...
              {types.map((type, idx) => (
                <SwiperSlide
                  ...
                  <div
                    className={`p-2 rounded-lg flex flex-col items-center justify-center w-[80%] h-full ${type.bg}`}>
                    {type.icon}
