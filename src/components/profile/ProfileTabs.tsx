  ...
  return (
    <Tabs value={activeTab} onValueChange={setActiveTab} className="mt-3">
      <TabsList className="flex flex-wrap justify-start gap-2 mb-6">
        ...
        <TabsTrigger value="progress" className="text-xs sm:text-sm px-3 py-2">
          Progression
        </TabsTrigger>
        <TabsTrigger value="results" className="text-xs sm:text-sm px-3 py-2">
          Résultats
        </TabsTrigger>
        <TabsTrigger value="contacts" className="text-xs sm:text-sm px-3 py-2">
          Contacts
        </TabsTrigger>
        <TabsTrigger
          value="classement"
        ...
        <TabsTrigger value="badges" className="text-xs sm:text-sm px-3 py-2">
          Badges
        </TabsTrigger>
      ...
      <TabsContent value="overview" className="space-y-6 mt-3 overflow-y-auto">
