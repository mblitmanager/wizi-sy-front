        ...
        <div className="flex flex-col-reverse items-center gap-8 md:gap-12">
          ...
          <motion.div
            ...
            <motion.p
              ...
              variants={slideUp}>
              Bienvenue sur Wizi Learn, la plateforme de quiz éducatifs pour nos stagiaires. 
              Testez vos connaissances, suivez votre progression et développez vos compétences professionnelles.
            </motion.p>
            ...
            <motion.div className="mt-8 text-center" variants={slideUp}>
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-4 justify-center items-center">
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-xs text-gray-500 mt-2">iOS • App Store</span>
                </div>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-xs text-gray-500 mt-2">Version Android • fichier APK</span>
                </div>
              </div>
            </motion.div>
          </motion.div>
