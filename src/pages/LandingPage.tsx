...
export default function LandingPage() {
  ...
  return (
    <Layout>
      <div className="bg-gradient-to-br from-[#FDF6ED] via-[#F7E7D2] to-[#F9E0C7]) min-h-screen mt-[-10%] md:mt-[-2%]">
        {!isOnline && (
              ...
              <motion.div
                ...
                <motion.div
                  ...
                  <Button
                    size="lg"
                    asChild
                    className="w-full md:w-auto bg-[#8B5C2A] hover:bg-[#A76C36] text-white font-semibold rounded-md px-4 py-2 transition-colors duration-200">
                    <Link
                      to="/login"
                      className="flex items-center justify-center bg-[#8B5C2A] hover:bg-[#A76C36] text-white font-semibold rounded-md px-4 py-2 transition-colors duration-200">
                  ...
                  <Button
                    ...
                    variant="outline"
                    asChild
                    className="w-full md:w-auto border-[#FF9900] text-[#FFF] bg-orange-500 hover:text-white hover:bg-[#FF9900]">
