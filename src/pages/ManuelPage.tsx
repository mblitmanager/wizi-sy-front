...
const sections = [
  {
    ...
    content: (
      <>
        ...
        <p className="mb-4">
          La section Quiz vous permet de tester vos connaissances et de
          ...
          <ul className="list-disc pl-5">
            <li>
              ...
              <div className="mt-2 text-sm text-gray-700">
                ...
                de sélectionner la ou les bonnes réponses proposées. Validez
                ensuite votre choix pour passer à la question suivante.
              </div>
            </li>
            <li>
              <strong>Intermédiaire</strong>{" "}
              <span className="text-xs">(+ les précédents)</span>
              <ul className="list-square pl-5">
              ...
              <div className="mt-2 text-sm text-gray-700">
                ...
                <ul className="list-disc pl-5">
                  <li>
                    ...
                    Sélectionnez dans la liste les bonnes réponses parmi les
                    mots proposés.
                  </li>
                  <li>
                    <span className="font-semibold">Correspondance :</span>{" "}
                    Faites correspondre chaque valeur de gauche avec celle de
                    droite en les associant correctement.
                  </li>
                  <li>
                    <span className="font-semibold">Carte flash :</span> Cliquez
                    sur la carte pour révéler la question, puis sélectionnez la
                    bonne réponse.
                  </li>
                </ul>
              </div>
              ...
              <div className="mt-2 text-sm text-gray-700">
                ...
                <ul className="list-disc pl-5">
                  <li>
                    ...
                    Ré-ordonnez la liste d'éléments pour obtenir la bonne
                    séquence.
                  </li>
                  <li>
                    ...
                    Analysez l'énoncé et remplissez la case correspondante avec
                    la bonne réponse.
                  </li>
                </ul>
              </div>
      ...
      <>
        ...
        <div className="mb-4">
          <h3 className="text-lg font-semibold mb-1">
            Installer l'application en mode PWA
          </h3>
          <ul className="list-disc pl-5 mb-2">
            <li>
              <strong>Sur Android :</strong> Ouvrez le site dans Chrome, cliquez
              sur le menu (⋮) puis sur "Ajouter à l'écran d'accueil".
              L'application sera installée comme une app native.
            </li>
            <li>
              <strong>Sur iOS :</strong> Ouvrez le site dans Safari, cliquez sur
              l'icône de partage (carré avec flèche), puis sur "Sur l'écran
              d'accueil". Validez pour installer l'application sur votre
              iPhone/iPad.
            </li>
          </ul>
        </div>
        <div className="mb-4">
          <h3 className="text-lg font-semibold mb-1">
            Installer l'application Android (APK)
          </h3>
          <ul className="list-disc pl-5 mb-2">
            <li>
              Téléchargez l'APK depuis l'accueil (bouton "Télécharger pour
              Android").
            </li>
            <li>
              Ouvrez le fichier téléchargé. Si un message "Installation bloquée"
              ou "Source inconnue" apparaît, cliquez sur{" "}
              <strong>Paramètres</strong> ou <strong>Autoriser</strong>.
            </li>
            <li>
              Activez "Autoriser l'installation depuis cette source" puis
              revenez à l'installation et validez.
            </li>
            <li>
              L'application est sûre et ne collecte aucune donnée personnelle en
              dehors de votre usage sur Wizi Learn.
            </li>
          </ul>
        </div>
        <p>
          Des tutoriels et astuces s'affichent automatiquement lors de la
          première utilisation de certaines fonctionnalités (quiz, installation
          de l'application, etc.). Vous pouvez aussi consulter les astuces en
          cliquant sur les liens dédiés.
        </p>
      </>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>
          Consultez votre position dans le classement général depuis la section
          dédiée. Le classement est basé sur vos points accumulés dans les quiz
          et formations.
        </p>
      </>
    ),
    ...
    content: (
      <>
        ...
        <p>
          ...
          lien redirige votre filleul vers une page dédiée où il peut
          sélectionner la formation de son choix pour une première inscription.
        </p>
        <p>
          Après l'inscription, votre filleul recevra un mail de confirmation et
          sera contacté par la suite par votre conseiller pour finaliser son
          accompagnement.
        </p>
        <p>
