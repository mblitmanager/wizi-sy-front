...
const contactTypes = [
  { id: 'trainer', label: 'Formateur', icon: Users, color: 'text-blue-600' },
  { id: 'commercial', label: 'Commercial', icon: Phone, color: 'text-green-600' },
  { id: 'support', label: 'Support', icon: Mail, color: 'text-purple-600' }
];
