...
const FormationsPage = () => {
  ...
  const [formations] = useState([
    { 
      id: 1, 
      name: "Word", 
      description: "Apprenez à utiliser Microsoft Word de manière professionnelle",
      progress: 75, 
  ...
  return (
    <div className="container mx-auto p-4 pb-20 md:pb-4">
      <h1 className="text-3xl font-bold mb-6">Formations</h1>
                ...
                <CardContent className="p-4 pt-0">
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-sm">{formation.students} apprenants</span>
                    </div>
                    <div className="flex items-center">
                ...
                <Card key={formation.id} className="overflow-hidden">
                  <div className="h-48 bg-muted relative">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <Badge className="text-lg px-4 py-2">Formation terminée</Badge>
                    </div>
                  </div>
                  <CardHeader className="p-4">
                    <CardTitle className="text-lg">{formation.name}</CardTitle>
                    <CardDescription>
                      Terminée le 01/04/2024
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="p-4 pt-0">
